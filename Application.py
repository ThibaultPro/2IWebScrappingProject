...
class Graph_dynam(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        button_updating_graph = ttk.Button(self, textvariable=button_updating_graph_var) #on déclare le bouton et on le bind au tk.StringVar()
        ...
        button_updating_scrap = ttk.Button(self, textvariable=button_updating_scrap_var)
